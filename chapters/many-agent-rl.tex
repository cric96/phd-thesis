...
Reinforcement learning sets itself apart from other methodologies 
 by operating without the need for labelled data or supervision and through a sequential interaction between an agent and an environment. 
...
In contemporary applications, neural networks have emerged as the go-to function approximators due to their exceptional capability to approximate complex, 
 ...
 One of the first and most influential works in this area was the Deep Q-Network (DQN) algorithm~\cite{DBLP:journals/corr/MnihKSGAWR13}, which will be discussed in the next section.
 ...
 The core idea behind DQN is to use a neural network as a function approximation for the Q-function in Q-Learning. 
...
However, in practice, the pursuit of equilibrium often fails to yield satisfactory results, 
 ...
 Distributed Q-Learning is a straightforward extension of the traditional Q-Learning algorithm designed for multi-agent systems. 
...
After this brief introduction, 
 ...
 starting from the formalization of the problem,
  and then we will discuss practical solutions and the gran-challenges.
...
The general learning process is then divided into a training phase performed offline, in a simulated environment, and an execution phase, performed online, in the real environment.
