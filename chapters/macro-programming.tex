...
%
\subsubsection{Field-based Programming Model: Examples}
\label{sec:field-calculus-foundational-behaviour}
The proposed model and language is quite simple and intuitive, 
...
\paragraph*{Self-healing gradient}
\paragraph*{Gradient-cast}
\paragraph*{Collect-cast}
\paragraph*{Sparse choice}
