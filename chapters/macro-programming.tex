...
\paragraph{Behavioural Properties}
...
Taking cues from self-stabilization principles, 
 ...
 barring a transient initial period, assuming that the inputs remain constant beyond this initial period. This eventual consistency is demonstrated for all programs expressible in the GPI calculus~\cite{Aud+18}.

Lastly, 
 contemporary work is beginning to examine the real-time performance guarantees of field calculus programs~\cite{Aud+18}. 
...
\subsubsection{High-level patterns}
...
For instance, in a large-scale temperature monitoring and control scenario, 
 we could create regions of uniform size. 
 Devices within each region could then collectively calculate the average temperature for that area. 
 Based on this collective data, 
 alarms could be generated for more coarse-grained analysis and interventions. 
\subsection{Tools}
