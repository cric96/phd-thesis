...
As a case in point, this thesis focuses on aggregate computing because it aligns closely with the needs of designing applications for Cyber-Physical Social Systems (CPSWs). 
...
In this regard, the thesis explores both \eh{hybrid} aggregate computing and standard engineering approaches, which is reflected in its structure. Specifically, our contributions toward a \ehybrid approach include:
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item \fullcite{aguzzi2021towards}
    \item \fullcite{delnevo2021encouraging}
\end{enumerate}
\section*{2022}
\begin{enumerate}
    \item \fullcite{aguzzi2022towards}
    \item \fullcite{casadei2022scafi}
    \item \fullcite{aguzzi2022dynamic}
    \item \fullcite{aguzzi2022addressing}
    \item \fullcite{aguzzi2022machine}
    \item \fullcite{casadei2022towards}
\end{enumerate}
\section*{2023}
\begin{enumerate}
    \item \fullcite{aguzzi2023field}
    \item \fullcite{domini2023scarlib}
    \item \fullcite{aguzzi2023macroswarm}
    \item \fullcite{aguzzi2023acgnn}
    \item \fullcite{aguzzi2023frasp}
