...
\Cref{part:learning} turns the spotlight on contemporary hybrid learning methodologies applicable to \acp{cpsw}.  
 Initially, \Cref{chap:marl} provides an exhaustive overview of the current landscape of reinforcement learning, 
 setting the stage for the terminologies and concepts deployed in subsequent chapters. 
 Following this, \Cref{chap:learning:roadmap} sketches a comprehensive roadmap for the amalgamation of aggregate computing and machine learning. 
 \Cref{chap:learning:sketching} introduces a groundbreaking technique for synthesizing collective programs. 
 In addition, \Cref{chap:learning:field-informed} presents an inventive approach to reinforcement learning within \acp{cpsw}, grounded in field calculus. 
 \Cref{chap:learning:schedulers} details a cutting-edge strategy for distributed scheduling in these complex systems. 
 Concluding this part, \Cref{chap:learning:scarlib} introduces an advanced toolkit designed for hybrid aggregate computing, 
 leveraging state-of-the-art deep learning libraries.

Finally, \Cref{chap:conclusion} synthesizes the thesis contributions, drawing conclusions and laying out avenues for future research in this evolving field.
