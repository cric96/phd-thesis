...
The widespread adoption of computational technologies kick off a transformative phase for the IT landscape, 
...
In this context, the term \emph{edge-cloud continuum} aptly encapsulates the current IT landscape. 
