...
Despite the hardware heterogeneity, nodes in a \ac{cpsw} exhibit homogeneous behaviour at a local level. 
 They execute identical local algorithms, ensuring that the collective goals of the system are met in a uniform manner.
...
One of the most striking features of \acp{cpsw} is their ability to self-organize. 
...
\paragraph*{Cyber-physical Integration}
...
\begin{table}[h]
    ...
    \hline
                                & MAS                         & Swarm Robotics          & CAS          & CPSW         \\ \hline
    ...
    \caption{Summarized comparison between MAS, Swarm Robotics, CAS and CPSW}
