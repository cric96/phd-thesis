...
Given that centralization is not feasible, 
 ...
 %This is especially critical given that these are often \emph{critical systems}, where delays in decision-making could have severe repercussions.
...
The sensors collect various types of data--
...
\begin{table}[h]
    ...
    Capabilities                & Heterogeneous                & Homogeneous              & Heterogeneous & Heterogeneous \\ \hline
    Behaviours                  & Heterogeneous                & Homogeneous              & Heterogeneous & Homogeneous   \\ \hline
    ...
    \label{table:cpsw-vs-rest}
\end{table}
This section will discuss some of the related concepts that are closely aligned with \acp{cpsw} summarized in \Cref{fig:overview-cpsw-taxonomy} and \Cref{table:cpsw-vs-rest}.
\begin{figure}
    \centering
...
\paragraph*{Swarm intelligence} It is a branch of collective intelligence with an interdisciplinary field that draws inspiration from the collective behaviours observed in social animals, 
