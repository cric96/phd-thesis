...
%
\chapter[ScaRLib]{ScaRLib: A Framework for Cooperative Many Agent Deep Reinforcement learning in Scala}\label{chap:rl:scarlib}%\mtcaddchapter%: A Framework for Cooperative Many Agent Deep Reinforcement learning in Scala}
%
