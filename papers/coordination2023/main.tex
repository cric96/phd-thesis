...
%
\chapter[Platform: Toolkit for Hybrid Aggregate Computing]{Platform: Toolkit for Hybrid Aggregate Computing}
\begin{flushright}
    \begin{minipage}{0.5\textwidth}
        How can we design a framework for the development of effective \ac{MAARL} systems

      -- \textbf{RQ2, RQ3, RQ4}    
    \end{minipage}
  \end{flushright}
\label{chap:rl:scarlib}%\mtcaddchapter%: A Framework for Cooperative Many Agent Deep Reinforcement learning in Scala}
%
\minitoc% Creating an actual minitoc
%
In this dissertation, 
 we advocate for a language-based approach to the engineering of \ac{cpsw}. 
 Specifically, we propose a hybrid vision that combines \ac{rl} and aggregate computing. 
 This approach underscores the need to create a corpus of solutions to address the overarching problem of \ac{MAARL}.
...
%
With \scafi{}, in particular, we support our language-based vision: \scarlib{} is provided with a high-level language for distributed computing that provides declarative
...
Furthermore, an implementation of the DQL algorithm \cite{Mnih2015} is provided and used to train agents. 
