...
\begin{itemize}
    ...
    \item the agent state space, 
    \item the action space and,
...
With this integration, 
 ...
 which has proven flexible in describing the most diverse environments outlined in \Cref{part:background}.
