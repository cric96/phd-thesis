...
\begin{flushright}
  \begin{minipage}{0.5\textwidth}
    ...
    Is it possible to use a \ac{GNN} to learn a policy for each agent in a swarm-like system?
...
%\ga{Page budget: 0.5}
In the next chapter, we will discuss how reinforcement learning can be used to platform aspects of the aggregate computing model.