...
\chapter[Field-informed Reinforcement Learning]{Field-informed Reinforcement Learning of Collective Tasks with Graph Neural Networks}\label{chap:rl:field-informed} %% Todo improve
\minitoc% 
