...
%
In particular, in this work, we consider \emph{homogenous \ac{MAARL}}~\cite{yang2021many}, 
...
%  
We present a subsequent approach where agent intelligence is synthesised through \ac{MAARL} and \ac{GNN} is used to learn a local representation from the neighbourhood.
%
...
\begin{figure}
  ...
  \Cref{fig:static} represents the scenario used during training \review{as well as during test}. 
...
\item minimise the number of agents without neighbours;
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.91\linewidth}
    ...
    \label{fig:reward}
  \end{subfigure}
  \caption{Training results of FIRL.
...
\begin{figure*}
  ...
  \begin{subfigure}[b]{0.9\linewidth}
    ...
    \caption{Ratio of coverage of the phenomena. Our \ac{FIRL} approach can outperform other approaches lacking field information.}
  ...
  \end{subfigure}
	\caption{Quantitative test results.
