...
\chapter[Field-informed Reinforcement Learning]{Field-informed Reinforcement Learning of Collective Tasks with Graph Neural Networks}\label{chap:rl:field-informed}%\mtcaddchapter %% Todo improve
\minitoc% 
...
Specifically, we propose a solution called \ac{FIRL} that utilizes aggregate computing together with a \ac{GNN}~\cite{Zhou2020AIOpen} in combination with a reinforcement learning approach, namely \ac{DQN}~\cite{mnih2015human}. 
