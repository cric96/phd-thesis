...
%
\Cref{sec:background} covers background on self-organization programming and the functional reactive paradigm.
%
...
In this section,
 we review approaches for self-organization engineering (\Cref{sec:background:selforg}),
...
First, we explain the system and execution model (\Cref{sec:sys-model});
 ...
 finally, we show how paradigmatic examples of self-organization can be expressed in \ac{langname} (\Cref{paradigmatic-examples}).
...
Even though a complete description of the implementation is beyond the aims of this paper,
 ...
 and to provide general guidance for understanding the code organization of the provided artefact (see \Cref{footnote:dsl}).
