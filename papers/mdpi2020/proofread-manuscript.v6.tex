...
Alma Mater Studiorum--Universit{\`a} di Bologna, Cesena, 47521, Italy;  gianluca.aguzzi@unibo.it (G.A.); mirko.viroli@unibo.it (M.V.)
%\\
...
%
The simulations are open-sourced and accessible from a public \hl{repository} %MDPI: This journal is not allowed to have footnotes, we moved it here, please confirm.
% this is fine
...
\funding{\hl{This research received no external funding.} %mdpi: Newly added information, please confirm.
% => this is fine
}
...
\newblock \emph{Software Engineering for Self-Adaptive Systems: {A} Second Research
  Roadmap};
\newblock   Springer:  \hl{Berlin/Heidelberg, Germany,} %mdpi: newly added information, please confirm ==> THIS IS FINE
  2010;
  Volume 7475, pp. 1--32.

\bibitem[Wooldridge(2009)]{wooldridge2009mas}
Wooldridge, M.J.
\newblock {\em An Introduction to MultiAgent Systems,}  2nd ed.; Wiley:  \hl{Hoboken, NJ, USA,} %mdpi: newly added information, please confirm ==> THIS IS FINE
 2009.
...
\newblock  International Workshop on Agent Theories, Architectures, and
  Languages; Springer:  \hl{Berlin/Heidelberg, Germany,} %mdpi: newly added information, please confirm => OK
  1996; pp. 21--35.
...
\newblock {\em Programming Multi-Agent Systems in AgentSpeak Using Jason};
   John Wiley \& Sons:  \hl{Hoboken, NJ, USA,} %mdpi: newly added information, please confirm => OK
  2007; Volume~8.
...
\newblock  In Proceedings of the Third International Conference on Information and
  Knowledge Management (CIKM'94), Gaithersburg, MD, USA, 29 November--\mbox{2 December} 1994; \hl{ACM: New York City, NY, USA} %MDPI: Please add the location of the publisher. => New York City, NY, USA
 1994; pp. 456--463,
\newblock
...
\newblock Environment Programming in CArtAgO. In {\em Multi-Agent Programming,
  ...
  Seghrouchni, A.E.F., Eds.; Springer:  \hl{Berlin/Heidelberg, Germany,} %MDPI: newly added information, please confirm => OK
 2009; pp. 259--288,
\newblock
...
\newblock {\em Field-Based Coordination for Pervasive Multiagent Systems};
  Springer Series on Agent Technology; Springer:  \hl{Berlin/Heidelberg, Germany,} %MDPI: newly added information, please confirm => OK
  2006.
\newblock
...
\newblock  Leveraging Applications of Formal Methods, Verification and
  ...
  Springer:  \hl{Berlin/Heidelberg, Germany,} %mdpi: newly added information, please confirm => OK
...
Dennett, D.C.
\newblock {\em The Intentional Stance}; MIT Press:  \hl{Cambridge, MA, USA,} %mdpi: newly added information, please confirm => OK
  1989.
...
\newblock   In~Proceedings of the International Conference on Coordination Languages and Models, \hl{ Kongens Lyngby, Denmark, June 17-21, 2019}; %MDPI: Please add the location and date of the conference. =>  Kongens Lyngby, Denmark, June 17-21, 2019
...
\newblock Holonic Multi-Agent Systems. In {\em Self-organising Software---From
  ...
  Karageorgos, A., Eds.; Natural Computing Series; Springer:  \hl{Berlin/Heidelberg, Germany,} %mdpi:newly added information, please confirm => OK
  2011; pp.
  251--279,
\newblock
...
\newblock Simulation-based complex adaptive systems. In {\em Guide to
  Simulation-Based Disciplines}; Springer:  \hl{Berlin/Heidelberg, Germany,} %mdpi: newly added information, please confirm => OK
  2017; pp. 127--150.
...
Fasli, M.
\newblock {\em Agent Technology for e-Commerce}; Wiley:  \hl{Hoboken, NJ, USA,} %mdpi: newly added information, please confirm => OK 
  2007.
...
\newblock   In Proceedings of the 10th International Workshop on Objects and Agents,  \hl{Parma, Italy, July 9-10, 2009}. %MDPI: Please add the location and date of the conference. => Parma, Italy, July 9-10, 2009
...
\newblock {\em Computational Collective Intelligence}; Wiley Series on Parallel
  and Distributed Computing; Wiley:  \hl{Hoboken, NJ, USA,}~ 2001.%mdpi: newly added information, please confirm => OK
