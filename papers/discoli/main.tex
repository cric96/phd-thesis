...
%
%For actual execution of an aggregate program,
...
%
First effort in this direction has been done in~\cite{DBLP:conf/coordination/CasadeiPVN19}, where a gradient algorithm has been learnt through a reinforcement learning approach. %TODO add reference to the right chapter.
...
For a given \ac{ac} program or algorithm,
  ...
  the retention of messages from neighbours (i.e., when should messages from the neighbor be considered too old to be used).
%
In particular,
 a first distinction 
...
%
In next chapters, 
 firstly we will introduce \scarlib{}: a tool for many-agent reinforcement learning developed to support our research.
% 
After that we will present a concrete application of \ac{acml} to improve the efficiency of a gradient algorithm
