...
\sloppypar    
\chapter{Machine Learning for Aggregate Computing}\label{chap:learning:roadmap}%\mtcaddchapter
...
%
First effort in this direction has been done in~\cite{DBLP:conf/coordination/CasadeiPVN19}, where a gradient algorithm has been learnt through a reinforcement learning approach~\Cref{chap:learning:sketching}.
