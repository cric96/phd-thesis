...
\end{lstlisting}
\end{lrbox}
\subfloat[\label{fig:example-scr-code}\scafi{} program]{
\usebox{\scrprogram}
}\\
\subfloat[\label{fig:example-scr-snapshot}Snapshot from the \scafi{} simulator (Big circles mark node as leader).]{
  \centering
  \includegraphics[width=0.8\linewidth]{papers/softwarex2021/imgs/scr-result.png}
}\\
\subfloat[\label{fig:example-temperature}Simulated temperature distribution.]{
