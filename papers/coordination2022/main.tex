...
As anticipated in \Cref{coordination2022:s:background:ac}, the behaviour of an aggregate system depends on the interplay of three main ingredients:
...
\subsection{Building blocks Refinement}\label{coordination2022:s:learning-gradient}
...
The gradient block (cf. \Cref{coordination2022:sec:gradient}) could be generalized as follows:
\begin{lstlisting}
...
\section{Conclusion}\label{coordination2022:s:conc}
