...
\chapter[Patterns: Dynamic Decentralization Domains]{Patterns: Dynamic Decentralization Domains for Cyber-Physical Swarm}\label{chap:eng:decentralization}%\mtcaddchapter
\begin{flushright}
  \begin{minipage}{0.5\textwidth}
    What is the right level of abstraction for programming \acp{cpsw}?
...
The application logic, leveraging our \ac{api}, is %captured by the code 
 shown in \Cref{code:example}--it exemplifies the abstractions (a)
