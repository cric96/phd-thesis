...
\chapter[Patterns: Coordinated Movements and Decision Making]{Patterns: Coordinated Movements and Decision Making}\label{chap:eng:macroswarm}%\mtcaddchapter
...
In this chapter, we introduce a formally-grounded \ac{api},
 ...
 to concisely and elegantly encode a wide array of swarm behaviours incorporating both coordinated movement and collective decision-making.
%
...
It is also possible to create teams based on predetermined leaders, 
 denoted explicitly by Boolean fields. %(instead of leveraging \lstinline|S| under the hood).
%
...
The first step is the formation of the teams, 
 ...
 The function \lstinline|circleIsFormed| verifies whether the nodes are in a circle formation, i.e., 
...
Voltron~\cite{Mottola2014voltron} is a programming model for team-level design of drone systems. It represents a group of individual drones through a \emph{team abstraction}, 
...
%
The runtime deals with the communication of facts and the removal of invalidated facts.
%
...
This chapter presents a comprehensive framework for top-down swarm programming, 
...
\begin{enumerate}
  ...
  \item A case study that validates the expressiveness and efficacy of the framework herein proposed.
\end{enumerate}

The discussions in \Cref{chap:eng:clustering,chap:eng:decentralization,chap:eng:macroswarm} contribute to the broader vision of developing a comprehensive set of design pattern for \ac{cpsw}. This aims to bridge the gap between domain-specific problems and their concrete implementations.
