...
The discussions in \Cref{chap:eng:clustering,chap:eng:decentralization,chap:eng:macroswarm} contribute to the broader vision of developing a swarm-API for \ac{cpsw}. This aims to bridge the gap between domain-specific problems and their concrete implementations.
