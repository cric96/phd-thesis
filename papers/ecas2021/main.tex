...
\Cref{background} introduces the current state of the art, discussing pulverization in the context of aggregate computing and multi-tier programming;
\Cref{multitier+pulverisation} discusses the possible integration of pulverized aggregate computing systems and multi-tier programming and shows initial experiments leveraging the \scafi{} and \scalaloci{} Scala domain-specific languages (DSLs);
...
\paragraph*{Programmability and compile-time safety of deployment architectures for pulverized systems}
%
