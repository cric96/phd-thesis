...
\caption[Examples of pulverized architectures.]{
Examples of pulverized architectures. Thick boxes represent physical devices, dashed boxes represent pulverized components, and different logical devices are identified by colour (red, green, and blue).
A pulverized component is hosted on the physical device in which it is contained.
