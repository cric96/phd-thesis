...
\begin{flushright}
  \begin{minipage}{0.5\textwidth}
    ...
    How this problem can be addressed in \ac{cpsw}?
    
    What are the \emph{assumptions} underlying the approach?

    Why is this problem relevant for \ac{cpsw}?
...
\subsubsection{Scenario 1: Gaussian patterns (\Cref{fig:standard})}
...
%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Scenario 2: Stretched Gaussian patterns (\Cref{fig:stretched})}
\label{scenario-2}
\subparagraph{Description}
...
%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Scenario 3: One direction temperature field (\Cref{fig:one-direction,,fig:one-direction-one-candidate})}
...
%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Scenario 4: Gaussian overlapped patterns (\Cref{fig:overlapped})}
\subparagraph{Description}
...
\subsubsection{Scenario 5: Non convex patterns (\Cref{fig:non-convex})}
\subparagraph{Description}
...
\subsubsection{Scenario 6: Gaussian patterns with movement}
\subparagraph{Description}
...
\subsubsection{Scenario 7: Variable size Gaussian pattern}
\subparagraph{Description}
...
\rev{
\subsubsection{Scenario 8: Random Failures}
\subparagraph{Description}
