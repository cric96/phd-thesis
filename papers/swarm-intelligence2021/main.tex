...
\section{\rev{Resilient} Dynamic Cluster Formation in Swarms}
...
%
This algorithm could serve as a foundational solution for organizing collective tasks based on environmental sensing data in the context of Cyber-Physical Social Wearable Systems (\ac{cpsws}), as discussed in \Cref{chap:cpsw:vision}.
