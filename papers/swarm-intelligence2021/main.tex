...
\item {\em Communication} is based on  peer-to-peer connection link, based on the proximity of robots, without relying on infrastructure (e.g., LTE network, Wi-Fi network).
...
In~\cite{DBLP:journals/arobots/BestFF18,DBLP:journals/ijrr/BestCPMF19},
 decentralized planning is used to support multi-robot active perception,
