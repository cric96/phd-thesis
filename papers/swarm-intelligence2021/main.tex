...
\chapter[Patterns: Sensing-driven Clustering in Swarms]{Patterns: Sensing-driven Clustering in Swarms: A Field-based computing approach}\label{chap:eng:clustering}\mtcaddchapter
