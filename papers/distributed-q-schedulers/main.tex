...
Specifically, we aim to use a global $Q$-table during the learning time, 
...
The agent, however, could \emph{inspect} the learning and evaluation process. 
 Therefore, the agent state should depend on locally produced export and outputs, 
...
\begin{figure}
    ...
    (the greener, the closer the nodes to the sources).
...
This behaviour may appear counter-intuitive.
 At first glance, indeed, we expect that the nodes tend to maintain a low-cost power consumption, 
