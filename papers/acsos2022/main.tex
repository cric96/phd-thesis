...
\begin{figure*}
 ...
 \begin{figure}
    ...
    \caption[Error and energy saving percentage (see \Cref{s:simulation-setup}) as nodes vary.]{\revision{Error and energy saving percentage (see \Cref{s:simulation-setup}) as nodes vary. 
