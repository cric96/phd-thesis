...
%        }
%        \label{acsos2022:fig:aggregate-computing}
%    \end{figure}
...
%%
%So for instance, 
% a field of temperatures could be mapped in a field of Boolean values that reveals zones in danger (\Cref{acsos2022:fig:aggregate-computing});
...
% the field calculus semantic and exposes the main operators through an \ac{api} (\Cref{acsos2022:code:dsl}). 
%
...
% and \emph{converge-cast} (\scafiinline{C})~\cite{DBLP:journals/jlap/ViroliBDACP19,DBLP:journals/cee/AudritoCDPV21} (\Cref{acsos2022:fig:c-and-g}). 
%%
...
As discussed in \Cref{acsos2022:s:background:ac},
...
\section{Conclusion}\label{acsos2022:sec:conclusion}
